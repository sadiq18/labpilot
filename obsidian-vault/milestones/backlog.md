...
- **Requires:** P1.5b kernel push + `competition_submit_code` + submission URLs in reflection (see kernel-only submission notes in [[../plans/P4 v1.0 Production|P4 v1.0 Production plan]]).
