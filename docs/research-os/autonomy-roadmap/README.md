...
| **M19** | [An experiment is a change to its parent](14-experiments-as-deltas.md) | Validation discipline is preserved, and violations are visible | **design, not started — the next build.** Templates cover 5 of 12 techniques on rogii; whole-file regeneration costs 46% of the prompt and can silently drop what worked |
