...
**Status:** Planned (docs; impl after M5 preferred path).  
...
| # | Plan | Focus |
|---|------|--------|
| 1 | [plan-1-experience-schema.md](plan-1-experience-schema.md) | Experience Record model + SQLite ExperienceStore |
| 2 | [plan-2-experience-extractor.md](plan-2-experience-extractor.md) | Deterministic extract: experiment/reflection → record |
...
| Metadata | SQLite ExperienceStore (cross-competition) |
