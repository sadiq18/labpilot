...
| 5 | [plan-5-write-hooks.md](plan-5-write-hooks.md) | Persist on completion; idempotent upsert | Done |
| 6 | [plan-6-capstone.md](plan-6-capstone.md) | Integration smoke + backlog handoff | Done |
