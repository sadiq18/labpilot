...
| Item | Focus |
|------|--------|
| [capability-registration.md](capability-registration.md) | Register new tools when `no_capability` volume justifies it · [design](../design/11-capability-registration.md) |
